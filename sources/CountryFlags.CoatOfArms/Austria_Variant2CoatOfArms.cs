...
public class Austria_Variant2CoatOfArms : CoatOfArms
{
    public Austria_Variant2CoatOfArms()
    {
        Country = Countries.Austria;

        Id = "Coa_Variant2";
        Label = "Coat of arms (Variant 2)";
        ...
        Comments = "Bundeswappen like the heraldic description in Art. 8a Abs. 2 B-VG with simplified eagle's feathers";
    }
}